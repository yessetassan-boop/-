...
1. Назови боль, которую лечит каждый из 7 паттернов — одной фразой.
2. Strategy vs Template Method — в чём разница механизма?
3. Decorator vs Adapter — что меняется, что сохраняется?
4. Decorator vs Chain of Responsibility — кто работает?
5. Формула декоратора-бина в Spring: какая аннотация где и почему?
6. Фаза vs поток в Observer — какие аннотации, можно ли комбинировать?
7. Почему SMS = AFTER_COMMIT, а не BEFORE_COMMIT?
8. Что такое anti-corruption layer?
9. Какие три кирпича лежат под всеми паттернами?

> Отвечаешь на все девять своими словами — паттерны у тебя в руках на уровне понимания, а не зубрёжки.
